document.addEventListener("DOMContentLoaded", () => {
    ...
    function switchPage(hash) {
        ...
        if (hash === "#dashboard") {
            ...
            subtitleEl.textContent = "Seçtiğiniz adıma göre arama motorundan canlı toplanan kaynaklar.";
    ...
    // --- SUGGESTIONS SECTION (Fully dynamic crawled items) ---
    ...
    elements.btnStartSimulation.onclick = async () => {
        ...
        try {
            ...
            runSimulationTimer([
                ...
                "18:00 - Günlük çalışma başarıyla sonlandırıldı."
            ]);
        }
    };
    ...
    function finishSimulation() {
        ...
        setTimeout(() => {
            ...
            elements.simulationRewardTitle.textContent = `Geleceğin ${state.career_goal} Adayı!`;
            elements.simulationRewardDesc.innerHTML = `
                Seçtiğiniz <strong>${state.career_goal}</strong> rolünü 15 saniye boyunca interaktif kapsülde başarıyla simüle ettiniz.<br>
                Gelecekteki yerin şimdiden hazır! Bugün hedefine ulaşmak için 1 adım atmaya ne dersin?
            `;
        }, 1500);
    }
